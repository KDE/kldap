...
public:
     ...
     * Puts the server's cookie into \a cookie, and returns the estimated
     * result set size. If the OID is not the page control's OID, or the
     * value cannot be decoded, returns -1.
     * \a cookie the cookie to hold server's cookie
     */
     ...
     * \a list the current list of controls
     * \a ctrl the control to insert
     * \since 4.4
     */
