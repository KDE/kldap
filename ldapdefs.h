...
/**
 * LDAP Error codes. These codes taken from openldap's ldap.h, and prefixed with KLDAP_
 * instead of LDAP_, just for applications which uses the kldap library doesn't need to
